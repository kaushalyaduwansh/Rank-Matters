...
export default function CalculateRRB({ examData }: { examData: any }) {
  ...
  const [zone, setZone] = useState(""); // New State for Zone
    ...
    try {
      ...
      const response = await fetch("/api/calculate-rrb", {
        ...
        body: JSON.stringify({
          url: inputUrl,
          category: category,
          userZone: zone, // Passing the selected Zone
          examId: examData.id
        }),
      });
          ...
          <form onSubmit={handleCalculate} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <Input
                  placeholder="https://rrb.digialm.com/.../ViewCandResponse..."
                  value={inputUrl}
                ...
                <SelectTrigger className="brand-focus w-full pl-3 bg-white border-zinc-200 text-zinc-900 focus:ring-0 focus:ring-offset-0 transition-all h-10">
                   <div className="flex items-center gap-3">
                      <MapPin 
                        ...
                        style={{ color: zone ? brandColor : undefined }}
                      />
